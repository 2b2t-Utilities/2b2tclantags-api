...
public class Clan {
	...
	public ITextComponent getInteractiveTag() {
		return ITextComponent.Serializer.jsonToComponent("{\"text\":\"[" + getAbbreviation() + "] \",\"color\":\"" + getColor() + "\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"" + ClanTags.PREFIX + "info " + getAbbreviation() + "\"}}");
	}
